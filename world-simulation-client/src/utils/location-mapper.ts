...
export const CITY_VALLEY_MAP: Record<string, Valley> = {
  // Valley of the Dawn
  'Tsin': Valley.Dawn,
 ...
 */
export function getCityValley(cityName: string): Valley | null {
 ...
 */
export function getCitiesInValley(valley: Valley): string[] {
 ...
 */
export function getCityCountByValley(): Record<Valley, number> {
  const counts: Record<Valley, number> = {
    [Valley.Dawn]: 0,
    [Valley.Day]: 0,
    [Valley.Dusk]: 0,
    [Valley.Night]: 0
...
export function searchCities(query: string): string[] {
  ...
  return Object.keys(CITY_VALLEY_MAP).filter(city =>
 ...
 */
export function getNeighboringValleys(valley: Valley): Valley[] {
 ...
 */
export function getOppositeValley(valley: Valley): Valley {
  switch (valley) {
 ...
 */
export function getRandomCityFromValley(valley: Valley): string | null {
...
export interface CityInfo {
  name: string;
  valley: Valley;
  isCapital: boolean; // Citadels are capitals
}
 ...
 */
export function getCapitalCities(): CityInfo[] {
...
export function getLocationStats(): LocationStats {
  ...
  const valleys = Object.entries(valleyDistribution) as [Valley, number][];
