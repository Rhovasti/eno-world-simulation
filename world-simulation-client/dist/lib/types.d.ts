...
export declare enum Valley {
    Dawn = "Dawn",
    Day = "Day",
    Dusk = "Dusk",
    Night = "Night"
}
export declare enum FundamentalNeed {
...
export declare enum IndividualAction {
    Working = "Working",
...
export declare enum SocialInteractionType {
...
export declare enum BuildingEventType {
    Upgraded = "Upgraded",
...
export declare enum CityEventType {
    Festival = "Festival",
    Election = "Election",
    Emergency = "Emergency",
...
export declare class SimulationClientError extends Error {
    code: string;
    details?: any;
